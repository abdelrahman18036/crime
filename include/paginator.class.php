...
class Paginator{
	...
	function paginate()
	{
		...
		if($this->num_pages > 1)
		{
			$this->return = ($this->current_page > 1 And $this->items_total >= 10) ? "<div class='row' style='display:inline;'><div class='col-sm-6'><ul class='pagination'><li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">Previous</a></li> ":"<div class='row'><div class='col-sm-6'><ul class='pagination'><li class='page-item'><a href=\"javascript:;\" class=\"page-link disabled\" tabindex=\"-1\">Previous</a></li> ";
		...
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			{
				$this->return .= ($i == $this->current_page) ? "<div class='row' style='display: inline; '><div class='col-sm-6'><ul class='pagination'><li class='page-item active'><a class=\"page-link\" href=\"#\">$i</a></li> ":"<li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
			}
	...
	function display_items_per_page()
	{
		...
		return "<div class='col-sm-6 float-sm-right' style='display: inline;     margin-top: 20px;'><div class='form-row mt-2 text-right'><div class='col' style='display: inline;'><span class=\"text-muted\">Rows:</span> <select  class=\"select\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select></div>\n";
	}
	function display_jump_menu()
	{
		...
		return "<div class='col' style='display: inline;'><span class=\"text-muted\">Page:</span> <select class=\"select\" style=\"width:100px\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$option</select></div><div class='col' style='display: inline;'><strong class='text-danger'>Total: ".$this->items_total."</strong></div></div></div></div>\n";
	}
